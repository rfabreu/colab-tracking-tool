    ...
    return new Promise((resolve, reject) => {
        db.query("SELECT name FROM departments", (err, result) => {
            ...
            result.forEach((department) => {
                newResult.push(department.name);
            });
...
function addNewEmployeeQuery(first_name, last_name, roleId) {
    return new Promise((resolve, reject) => {
...
module.exports = { getDepartments, getDepartmentNames, getRoleNames, getEmployeeNames, getManagerNames, addDepartmentQuery, getRoles, getDepartmentId, getRoleId, getEmployeeId, addRoleQuery, addNewEmployeeQuery, returnLastEmployee, addEmployeeManagerQuery, returnEmployees, updateCollaboratorRoleQuery, showEmployeesByManager };
